...
class CreatedHandler(FileSystemEventHandler):
    ...
    def on_created(self, event):
        ...
        changed = True
        points, nro = allNodes([1,
                                "/home/default/workspace/repos/python/bonn-motion-parser/mobilityGenerator/build/borrar39",
                                "/home/default/workspace/repos/python/bonn-motion-parser/mobilityGenerator/build/obs"])
        ax.cla()
        plt.close()
        return
...
if __name__ == "__main__":
  ...
  observer = Observer()
  observer.schedule(event_handler, path='/home/default/workspace/repos/python/bonn-motion-parser/parser/', recursive=True)
  observer.start()
  changed = False
  fig = plt.figure()
  ...
  ax.grid()
  lineList = []
  points, nro = allNodes(["/home/default/workspace/repos/python/bonn-motion-parser/mobilityGenerator/build/borrar0",
                          "/home/default/workspace/repos/python/bonn-motion-parser/mobilityGenerator/build/obs"])
  for i in range(nro):
    linea, = ax.plot([], [], lw=2)
